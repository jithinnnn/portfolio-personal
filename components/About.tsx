...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} style={{ position: "relative", zIndex: 1, padding: isMobile ? "80px 0" : "120px 0" }}>
      {/* Marquee strip */}
      <div style={{
        overflow: "hidden", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)",
        padding: "14px 0", marginBottom: isMobile ? 48 : 100, background: "rgba(124,58,237,0.03)",
      }}>
        <div style={{ display: "flex", gap: 48, width: "max-content", animation: "marquee 30s linear infinite" }}>
          {[...marqueeItems, ...marqueeItems].map((item, i) => (
            <span key={i} style={{
              fontFamily: "var(--font-mono), monospace", fontSize: 12, color: "var(--text-muted)",
        ...
        <div style={{
          ...
          <div>
            ...
            {[
              ...
              <p key={i} style={{
                fontSize: 16, lineHeight: 1.8, color: "var(--text-secondary)", marginBottom: 18,
                textAlign: isMobile ? "center" : "left",
                opacity: visible ? 1 : 0,
            ...
            <div style={{
              ...
              <div style={{
                fontSize: 24, width: 44, height: 44, background: "rgba(124,58,237,0.1)",
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ position: "relative", textAlign: "center" }}>
                <div style={{
                  ...
                  fontSize: 28, fontWeight: 800, color: "#fff", fontFamily: "var(--font-mono), monospace",
                }}>JG</div>
            ...
            <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 14, padding: 22 }}>
              <p style={{
                fontFamily: "var(--font-mono), monospace", fontSize: 11, color: "var(--violet-bright)",
              ...
              {[
                ...
                <div key={item.label} style={{
                  ...
                  <div>
                    <span style={{
                      fontFamily: "var(--font-mono), monospace", fontSize: 10, color: "var(--text-muted)",
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer"
      ...
      style={{
        ...
        textDecoration: "none", transition: "all 0.22s ease", letterSpacing: "0.04em",
      }}>{label}</a>
  );
}
